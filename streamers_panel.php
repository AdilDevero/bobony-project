    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input name="name" placeholder="Streamer Name" required
        ...
        <div class="grid">
            <?php while ($row = $streamers->fetch_assoc()): ?>
                <div class="card">
                    ...
                    <?php if ($row['link1']): ?>
                        <a href="<?php echo htmlspecialchars($row['link1']); ?>" target="_blank" class="btn small gray">Link
                            1</a>
                    <?php endif; ?>

                    <?php if ($row['link2']): ?>
                        <a href="<?php echo htmlspecialchars($row['link2']); ?>" target="_blank" class="btn small gray">Link
                            2</a>
                    <?php endif; ?>

                    <?php if ($role === 'owner' || $role === 'admin'): ?>
                        <div style="margin-top:10px;">
                            <a href="streamers_panel.php?action=edit&id=<?php echo (int) $row['id']; ?>"
                                class="btn small gray">Edit</a>
